...
<a href="https://webscrape.dev" target="_blank" rel="noopener noreferrer">
  <img src="webscrapedev.png" />
</a>
...
- [AgentGPT by Reworkd](https://agentgpt.reworkd.ai/) [![Stars](https://img.shields.io/github/stars/reworkd/AgentGPT?style=social)](https://github.com/reworkd/AgentGPT) - Deploy autonomous AI agents in your browser.
- [Browserbase](browserbase.com) [![Stars](https://img.shields.io/github/stars/browserbase?style=social)](https://github.com/browserbase) - Cloud infrastructure platform providing scalable browser instances and APIs for web automation and testing.
...
- [AgentQL](https://www.agentql.com/) [![Stars](https://img.shields.io/github/stars/tinyfish-io/agentql?style=social)](https://github.com/tinyfish-io/agentql) - Query language and toolkit that makes the web AI-ready.
- [Manus](https://manus.im/) - General AI agent capable of executing long-running tasks across browsers, terminals, and text editors.
- [OmniParser by Microsoft](https://microsoft.github.io/OmniParser/) [![Stars](https://img.shields.io/github/stars/microsoft/OmniParser?style=social)](https://github.com/microsoft/OmniParser) - Tool for parsing GUIs to enable vision-based agents.
- [Playwright Browser Toolkit by LangChain](https://python.langchain.com/docs/integrations/tools/playwright/#use-within-an-agent) [![Stars](https://img.shields.io/github/stars/langchain-ai/langchain?style=social)](https://github.com/langchain-ai/langchain) - Toolkit integration enabling AI agents to control browsers.
...
- [Agent-E by Emergence AI](https://www.emergence.ai/web-automation-api) [![Stars](https://img.shields.io/github/stars/EmergenceAI/Agent-E?style=social)](https://github.com/EmergenceAI/Agent-E) - Agent framework with HTML DOM distillation capabilities.
- [Browser Use](https://www.browser-use.com/) [![Stars](https://img.shields.io/github/stars/browser-use?style=social)](https://github.com/browser-use) - State-of-the-art agent framework making the web LLM-friendly with autonomous navigation.
- [Bytebot](https://github.com/bytebot-ai/bytebot) [![Stars](https://img.shields.io/github/stars/bytebot-ai/bytebot?style=social)](https://github.com/bytebot-ai/bytebot) - Containerized computer use agent framework with AI-powered scraping capabilities.
...
- [Expand.ai](https://www.expand.ai/) [![Stars](https://img.shields.io/github/stars/graphql/graphiql?style=social)](https://github.com/graphql/graphiql) - Platform converting websites into type-safe APIs.
- [Firecrawl](https://www.firecrawl.dev/) [![Stars](https://img.shields.io/github/stars/mendableai/firecrawl?style=social)](https://github.com/mendableai/firecrawl) - APIs for converting websites into LLM-friendly markdown.
- [LLM Scraper](https://github.com/mishushakov/llm-scraper) [![Stars](https://img.shields.io/github/stars/mishushakov/llm-scraper?style=social)](https://github.com/mishushakov/llm-scraper) - Intelligent scraping tool using LLMs for content understanding.
- [LaVague](https://www.lavague.ai/) [![Stars](https://img.shields.io/github/stars/lavague-ai/LaVague?style=social)](https://github.com/lavague-ai/LaVague) - Framework enabling natural language web automation.
- [Lightfeed](https://lightfeed.ai) [![Stars](https://img.shields.io/github/stars/lightfeed?style=social)](https://github.com/lightfeed) - AI-powered platform using LLMs to extract and structure data from any website.
- [Multilogin](multilogin.com) - Advanced browser fingerprinting protection and multi-account management solution.
- [Scrapfly](https://scrapfly.io) [![Stars](https://img.shields.io/github/stars/scrapfly?style=social)](https://github.com/scrapfly) - Comprehensive data collection APIs including web scraping and AI-powered extraction.
- [Self-Operating Computer Framework by OthersideAI](https://github.com/OthersideAI/self-operating-computer) [![Stars](https://img.shields.io/github/stars/OthersideAI/self-operating-computer?style=social)](https://github.com/OthersideAI/self-operating-computer) - Framework enabling multimodal models to operate computers.
- [Skyvern](https://www.skyvern.com/) [![Stars](https://img.shields.io/github/stars/skyvern-ai/skyvern?style=social)](https://github.com/skyvern-ai/skyvern) - Framework for automating browser-based workflows.
- [Stagehand by Browserbase](https://www.stagehand.dev/) [![Stars](https://img.shields.io/github/stars/browserbase/stagehand?style=social)](https://github.com/browserbase/stagehand) - AI web browsing framework.
- [Upscrape](https://www.upscrape.com) - High-performance web scraping systems and automation workflows for data collection.
- [WebAgent by OpenAgents](https://github.com/xlang-ai/OpenAgents) [![Stars](https://img.shields.io/github/stars/xlang-ai/OpenAgents?style=social)](https://github.com/xlang-ai/OpenAgents) - Web-browsing agent module enabling autonomous website navigation.
...
- [Browser MCP](https://autobrowser.ai/) [![Stars](https://img.shields.io/github/stars/browsermcp/mcp?style=social)](https://github.com/browsermcp/mcp) - Free Chrome extension using Claude Computer Use for browser automation.
...
- [Nanobrowser](https://nanobrowser.ai/) [![Stars](https://img.shields.io/github/stars/nanobrowser/nanobrowser?style=social)](https://github.com/nanobrowser/nanobrowser) - Open-source AI web agent Chrome extension with flexible LLM options.
- [VimGPT](https://github.com/ishan0102/vimGPT) [![Stars](https://img.shields.io/github/stars/ishan0102/vimGPT?style=social)](https://github.com/ishan0102/vimGPT) - Experimental project using GPT-4 Vision for web browsing via Vimium.
...
- [BrowserCat](https://www.browsercat.com) [![Stars](https://img.shields.io/github/stars/browsercat?style=social)](https://github.com/browsercat) - Headless browser API for automating web tasks including scraping and testing.
- [Browserless](browserless.io) [![Stars](https://img.shields.io/github/stars/browserless/browserless?style=social)](https://github.com/browserless/browserless) - Cloud-based headless browser automation and web scraping infrastructure.
...
- [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) [![Stars](https://img.shields.io/github/stars/Significant-Gravitas/AutoGPT?style=social)](https://github.com/Significant-Gravitas/AutoGPT) - Experimental agent for task completion and web browsing.
...
- [Computer Use by Anthropic](https://www.anthropic.com/news/3-5-models-and-computer-use) [![Stars](https://img.shields.io/github/stars/sierra-research/tau-bench?style=social)](https://github.com/sierra-research/tau-bench) - Advanced computer use agent with comprehensive browser control capabilities.
- [Crawl4AI](https://crawl4ai.com/) [![Stars](https://img.shields.io/github/stars/unclecode/crawl4ai?style=social)](https://github.com/unclecode/crawl4ai) - Open-source LLM-friendly web crawler and scraper for intelligent data extraction.
...
- [ABCproxy](ABCproxy.com) [![Stars](https://img.shields.io/github/stars/ABCproxy?style=social)](https://github.com/ABCproxy) - Proxy server service for secure and anonymous internet browsing.
- [AbstractAPI](abstractapi.com) [![Stars](https://img.shields.io/github/stars/abstractapi?style=social)](https://github.com/abstractapi) - API-first proxy service with IP geolocation tools for web scraping.
...
- [Apify](apify.com) [![Stars](https://img.shields.io/github/stars/apify?style=social)](https://github.com/apify) - Web scraping platform with proxy services for data extraction.
- [AstroProxy](astroproxy.com) - Proxy service for secure internet connectivity and data access.
- [BlockMesh](blockmesh.xyz) [![Stars](https://img.shields.io/github/stars/block-mesh/block-mesh-support-faq?style=social)](https://github.com/block-mesh/block-mesh-support-faq/tree/main) - Proxy service for enhanced privacy and connectivity.
...
- [Evomi](evomi.com) [![Stars](https://img.shields.io/github/stars/evomi?style=social)](https://github.com/evomi) - Proxy service for IP rotation and geo-location.
...
- [HasData](hasdata.com) [![Stars](https://img.shields.io/github/stars/HasData?style=social)](https://github.com/HasData) - Proxy services for enterprise-level data acquisition.
...
- [Mellowtel](mellowtel.com) [![Stars](https://img.shields.io/github/stars/mellowtel-inc?style=social)](https://github.com/mellowtel-inc/) - Proxy service for secure web scraping and browsing.
...
- [PacketStream](packetstream.io) [![Stars](https://img.shields.io/github/stars/packetstream?style=social)](https://github.com/packetstream/) - Residential proxy network for web scraping.
...
- [ScrapingAnt](https://scrapingant.com) [![Stars](https://img.shields.io/github/stars/ScrapingAnt?style=social)](https://github.com/ScrapingAnt) - Simple web scraping API with proxy rotation.
...
- [Spider Cloud](spider.cloud) [![Stars](https://img.shields.io/github/stars/spider-rs/spider?style=social)](https://github.com/spider-rs/spider) - Proxy service for web scraping and data collection.
...
- [WebScraping.AI](webscraping.ai) [![Stars](https://img.shields.io/github/stars/webscraping-ai?style=social)](https://github.com/webscraping-ai) - AI-powered web scraping service for complex websites.
...
- [Kameleo](kameleo.io) [![Stars](https://img.shields.io/github/stars/kameleo-io?style=social)](https://github.com/kameleo-io) - Browser fingerprinting protection and proxy management solutions.
...
- [Oxylabs](oxylabs.io) [![Stars](https://img.shields.io/github/stars/oxylabs?style=social)](https://github.com/oxylabs) - Enterprise-grade proxy solutions for web data extraction.
...
- [Bananalyzer](https://github.com/reworkd/bananalyzer) [![Stars](https://img.shields.io/github/stars/reworkd/bananalyzer?style=social)](https://github.com/reworkd/bananalyzer) - Open-source evaluation framework for web-based AI agents.
- [BrowserGym by ServiceNow](https://github.com/ServiceNow/BrowserGym) [![Stars](https://img.shields.io/github/stars/ServiceNow/BrowserGym?style=social)](https://github.com/ServiceNow/BrowserGym) - Gym environment for web task automation.
- [Mind2Web](https://osu-nlp-group.github.io/Mind2Web) - Large-scale dataset for generalist web agents.
- [MiniWoB++ by Farama Foundation](https://miniwob.farama.org/) [![Stars](https://img.shields.io/github/stars/Farama-Foundation/miniwob-plusplus?style=social)](https://github.com/Farama-Foundation/miniwob-plusplus) - Suite of 104 mini web browser tasks for testing.
- [WebArena](https://webarena.dev/) [![Stars](https://img.shields.io/github/stars/web-arena-x/webarena?style=social)](https://github.com/web-arena-x/webarena) - Realistic web environment for autonomous agents with performance tracking.
- [WebCanvas](https://github.com/iMeanAI/WebCanvas) [![Stars](https://img.shields.io/github/stars/iMeanAI/WebCanvas?style=social)](https://github.com/iMeanAI/WebCanvas) - Online evaluation framework for testing agents on live websites.
...
- [WebVoyager](https://github.com/MinorJerry/WebVoyager) [![Stars](https://img.shields.io/github/stars/MinorJerry/WebVoyager?style=social)](https://github.com/MinorJerry/WebVoyager) - Vision-enabled web agent using GPT-4V for website interaction.
